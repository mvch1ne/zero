...
SprintLab is a web application I made to help sprinters perform kinematic analysis on their training videos so they can gain insights and improve their performance. It's a React single-page app built with TypeScript. It talks to a separate Python backend built with FastAPI and MMPose for research-level pose estimation and tracking of body landmarks. I also added Three.js for a 3D view (because why not 😂?)
